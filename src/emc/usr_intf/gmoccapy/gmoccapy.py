...
## =============================================================
    ...
    def _periodic(self):
        ...
        self.gui.widgets.lbl_time.set_label(strftime("%H:%M:%S") + "\n" + strftime("%d.%m.%Y"))
...
# button handlers Start
    ...
    def _estop_active(self, object, state):
        print("estop ", object, state)
        if state:  # estop is active, open circuit
